    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            ...
            for i in range(common.CocoPart.Background.value):
                ...
                centers[i] = center
                cv2.circle(npimg, center, 3, common.CocoColors4[i], thickness=2, lineType=8, shift=0)
    ...
    def draw_humans2(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            ...
            for pair_order, pair in enumerate(common.CocoPairsRender):
                ...
                # npimg = cv2.line(npimg, centers[pair[0]], centers[pair[1]], common.CocoColors[pair_order], 3)
                cv2.line(npimg, centers[pair[0]], centers[pair[1]], common.CocoColors2[pair_order], 2)

        return npimg

    def draw_humans3(npimg, humans, imgcopy=False):
        if imgcopy:
            npimg = np.copy(npimg)
        image_h, image_w = npimg.shape[:2]
        centers = {}
        for human in humans:
            ...
            for pair_order, pair in enumerate(common.CocoPairsRender):
                ...
                # npimg = cv2.line(npimg, centers[pair[0]], centers[pair[1]], common.CocoColors[pair_order], 3)
                cv2.line(npimg, centers[pair[0]], centers[pair[1]], common.CocoColors3[pair_order], 2)

        return npimg

    def draw_humans4(npimg, humans, imgcopy=False):
        if imgcopy:
            npimg = np.copy(npimg)
        image_h, image_w = npimg.shape[:2]
        centers = {}
        for human in humans:
            ...
            for pair_order, pair in enumerate(common.CocoPairsRender):
                ...
                # npimg = cv2.line(npimg, centers[pair[0]], centers[pair[1]], common.CocoColors[pair_order], 3)
                cv2.line(npimg, centers[pair[0]], centers[pair[1]], common.CocoColors4[pair_order], 2)
