...
class Lunges(QThread):
    ...
    def run(self):
        ...
        global height, width
        self.cap = cv2.VideoCapture('oliwial.mp4')
        self.cap.set(3, 480)
        self.cap.set(4, 640)
        self.cap.set(5, 7)
        ...
        while True:
            ...
            if ret1:
                ...
                if len(pose) > 0:
                    ...
                    print(str(angleNeckR))
                    if angleKneeR < 145:
                        cv2.putText(image1, "Nie zginaj kolan!", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                    if angleHipR < 145:
                        cv2.putText(image1, "Tylek nizej!", (20, 55), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                    if angleNeckR < 150:
                        cv2.putText(image1, "Patrz przed siebie!", (20, 80), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
...
class Plank(QThread):
    ...
    def run(self):
        global height, width
        self.cap = cv2.VideoCapture('oliwiap.mp4')
        self.cap.set(3, 480)
        self.cap.set(4, 640)
        self.cap.set(5, 7)
        self.fourcc = cv2.VideoWriter_fourcc(*'XVID')
        ...
        while True:
            ...
            if ret1:
                ...
                if len(pose) > 0:
                    ...
                    if angleAnkleR < 80:
                        cv2.putText(image1, "Trzymaj kat prosty w lokciach!", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                    if angleKneeR < 125:
                        cv2.putText(image1, "Nie zginaj kolan!", (20, 55), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                    if angleHipR < 115:
                        cv2.putText(image1, "Tylek nizej!", (20, 80), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                    if angleNeckR < 130:
                        cv2.putText(image1, "Patrz przed siebie!", (20, 105), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                    ...
                    if plank(angleAnkleR, angleAnkleL, angleKneeR, angleKneeL, angleHipR, angleHipL, angleNeckR,
                        ...
                        if plankDone(angleAnkleR, angleAnkleL):
                            image1 = TfPoseEstimator.draw_humans3(image1, pose, imgcopy=False)
                            cv2.putText(image1, "Tak trzymaj!", (20, 130), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                        color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                else:
                    cv2.putText(image1, "Brak uzytkownika na obrazie!", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
...
class Squats(QThread):
    ...
    def run(self):
        global height, width
        self.cap = cv2.VideoCapture('oliwiasq2.mp4')
        self.cap.set(3, 480)
        self.cap.set(4, 640)
        self.cap.set(5, 7)
        self.fourcc = cv2.VideoWriter_fourcc(*'XVID')
        ...
        while True:
            ...
            if ret1:
                ...
                if len(pose) > 0:
                    ...
                    if angleNeckR < 120:
                        cv2.putText(image1, "Patrz przed siebie!", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                    if shoulders_distance <= 0.55 * foot_distance:
                        cv2.putText(image1, "Stopy za szeroko!", (20, 55), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                    if shoulders_distance >= 1.3 * foot_distance:
                        cv2.putText(image1, "Rozszerz stopy!", (20, 80), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                    if knee_distance <= 0.7 * foot_distance:
                        cv2.putText(image1, "Kolana zbyt wasko!", (20, 105), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                    if knee_distance >= 1.35 * foot_distance:
                        cv2.putText(image1, "Kolana za szeroko!", (20, 130), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                    ...
                    if squats(angleKneeR, angleKneeL, angleNeckR, angleNeckL) and (
                        ...
                        if squatsDone(angleKneeR, angleKneeL):
                            ...
                            if squatDoneScore(angleKneeR, angleKneeL):
                                image1 = TfPoseEstimator.draw_humans4(image1, pose, imgcopy=False)
                                cv2.putText(image1, "Powrot do gory!", (20, 80), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                            color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                else:
                    cv2.putText(image1, "Brak uzytkownika na obrazie!", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
            ...
            if ret1:
                ...
                if len(ball) > 0:
                    ...
                    if radius > 10:
                        ...
                        cv2.putText(image1, "Czas: {:0>2}:{:05.2f}".format(int(minutes), seconds), (20, 30),
                                    cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
                else:
                    cv2.putText(image1, "Nie wykryto piłki", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                color=(255, 255, 255), thickness=2, lineType=cv2.LINE_8)
